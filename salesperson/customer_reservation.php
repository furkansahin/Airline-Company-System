						...
						while($row = mysqli_fetch_array($temp, MYSQL_ASSOC)) {
							...
							if (strtotime($row['date']) > strtotime($today))
							{
								$html = $html 	.	"<div class=\"panel panel-success\">"
												...
												.	"<a style=\"margin-top: -20px;\" href=\"customer_reservation.php?function=4&val=".$row['ticket_no']."&user_name=".$name."&type=t\""
												.	" class=\"btn btn-warning pull-right btn-xs\">Change Seat</a>"

												.	"<a style=\"margin-top: -20px;\" href=\"customer_reservation.php?function=5&val=".$row['ticket_no']."&user_name=".$name."&type=t\""
												.	" class=\"btn btn-warning pull-right btn-xs\">Buy Extra Luggage</a>"


												.	"<a style=\"margin-top: -20px;\" href=\"customer_reservation.php?function=6&val=".$row['ticket_no']."&user_name=".$name."&type=t\""
												.	" class=\"btn btn-warning pull-right btn-xs\">Change Meal</a>"


												.	"<a style=\"margin-top: -20px;\" href=\"customer_reservation.php?function=7&val=".$row['ticket_no']."&user_name=".$name."&type=t\""
						...
						<div class="modal-body">
							...
							<form class="form-signin" action='extraLuggageAdd.php' method='POST'>
								<?PHP
									...
									echo "<input name=\"user_name\" type=\"hidden\" value=\"".$name."\">";
